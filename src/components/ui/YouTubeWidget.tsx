...
export const YouTubeWidget: React.FC = () => {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-20 md:bottom-24 left-4 md:left-6 z-50 flex items-center gap-3 group pointer-events-auto cursor-pointer"
    >
      ...
      <div className="bg-deep-charcoal/80 backdrop-blur-md border border-white/10 px-3 py-1.5 rounded-lg opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none">
        <span className="text-[10px] font-black uppercase tracking-widest text-text-primary whitespace-nowrap">Chaine YouTube</span>
      </div>
    </motion.a>
  );
};
